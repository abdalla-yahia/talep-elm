    ...
    <Container>
      <Row>
        <section className="flex  justify-start items-start gap-1">
          ...
          <div className="md:w-5/6 lg:w-5/6 w-4/6 h-full gap-3 bg-second_background_color min-h-screen rounded p-3 flex justify-start items-start flex-col flex-wrap">
