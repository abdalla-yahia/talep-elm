...
export const metadata: Metadata = {
  ...
  description: "الموقع الرسمي لطالب العلم الشرعي , يحتوي على المنهج العلمي لكل طالب علم يسعى إلى الإرتقاء في  سلم طلب العلم الشرعي وفق منهج علمي على الكتاب والسنة",
  openGraph: {
    title: "الموقع الرسمي لطالب العلم الشرعي",
    description: "الموقع الرسمي لطالب العلم الشرعي , يحتوي على المنهج العلمي لكل طالب علم يسعى إلى الإرتقاء في  سلم طلب العلم الشرعي وفق منهج علمي على الكتاب والسنة",
    images: [
    ...
    siteName: "الموقع الرسمي لطالب العلم الشرعي",
    type: "website",
    locale: "ar_AR",
  ...
  applicationName: "الموقع الرسمي لطالب العلم الشرعي",
  authors: [
    {
      name: "م/ عبدالله يحيى",
