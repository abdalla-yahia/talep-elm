  ...
  return (
    <div className="flex w-full justify-start items-center flex-col p-3 gap-2 text-gray-700">
        ...
        <div className="flex md:justify-between my-3 relative lg:justify-between justify-center  items-center lg:w-[70%] shadow-sm w-full gap-2 p-2 rounded">
                <label htmlFor="file" className="w-full cursor-pointer text-center rounded text-white p-2 bg-gray-500"> رفع ملفات
                ...
                <button onClick={()=>CreateLessonHandeller()} className="w-full p-3 cursor-pointer hover:bg-blue-500 hover:text-white rounded text-xl bg-blue-300 text-gray-700">حفظ الدرس</button>
    </div>
  )
}
