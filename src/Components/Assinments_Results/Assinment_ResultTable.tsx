            ...
            return (
              ...
              >
                ...
                <div className=" border-1 border-blue-400  table-cell text-center items-center ">
                  {sorce?.answersbody &&
                    JSON.parse(sorce?.answersbody).filter(
                        ...
                        <div className="flex flex-col bg-transparent border-none  items-center">
                          {e?.answer?.map((ans, i) => {
                            return (
                              ...
                              >
                                {JSON.parse(
                                  sorce?.answersbody as unknown as string
                                )
                                  ?.filter(
                                    (ele: { id: string }) => ele.id === e.id
                                  )[0]
                                  ...
                                  <span className="text-gray-300 relative flex bg-transparent border-none justify-center items-center ">
                                    {ans}
                                    {(CorrectDegree = false)}
                                    <icon.FaXmark className="text-accent_color absolute bg-transparent border-none" />
                                  </span>
                                )}
                              </div>
                            );
                              ...
                              (
                                ...
                                return e?.answer?.includes(
                                  ...
                                  >
                                    {it}
                                    {(CorrectDegree = false)}
                                    <icon.FaXmark className="text-accent_color bg-transparent border-none" />
                                  </span>
                                );
                              }
                            )}
                    ...
                    <div className="flex flex-col bg-transparent border-none justify-center items-center">
                      {JSON.parse(sorce?.answersbody as unknown as string).filter(
                        (ele: { id: string }) => ele.id === e.id
                      )[0]?.answer === e.answer ? (
                        ...
                        <span className="text-accent_color gap-2 flex bg-transparent border-none justify-center items-center ">
                          {
                            JSON.parse(
                              sorce?.answersbody as unknown as string
                            )?.filter((ele: { id: string }) => ele.id === e.id)[0]
                ...
                <span
                  className={`${CorrectDegree !== true &&
                    "line-through text-gray-400 text-center"
                    } border-1 border-blue-400  hidden md:table-cell lg:table-cell text-center`}
                >
                  {e.degree} درجة
                </span>
              </div>
