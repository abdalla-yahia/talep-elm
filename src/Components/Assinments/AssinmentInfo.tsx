    ...
    <>
      ...
      <div className="w-full">
        <h2 className="text-center flex gap-2 text-xl my-3 font-bold text-gray-900">
          معلومات عن التكليف:
          <p className="font-bold text-accent_color">{Assinment.description} </p>
        </h2>
        <h2 className="text-center flex gap-2 text-xl my-3 font-bold text-gray-900">
        ...
        {toggle && (
          <>
            <div className="text-center flex flex-col w-full gap-2 text-xl my-3 font-bold text-gray-900">
              <p className="text-3xl text-accent_color shadow p-2"> الإمتحان </p>
              {Assinment?.assinmentbody?.time && (
                <TimerQuestions
              ...
              <span>
                ...
                <span className="text-accent_color font-bold">{FullDegree} </span>
                درجة
              </span>
