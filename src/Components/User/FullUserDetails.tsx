    ...
    <>
     <div key={user?.id} className={`${user?.gender === 'MALE'?'bg-slate-400 shadow': 'bg-blue-300 shadow'} w-full min-h-36 text-center p-1 rounded flex flex-col mb-6  `}>
        ...
        <Image className="shadow mb-3 shadow-orange-400 rounded-[10%]" height={480} width={180} src={user?.image || (user?.gender === 'FEMALE'?images.female_user2:images.male_admin) } alt="user"  />
          ...
          <div className="flex justify-start flex-wrap items-center w-full gap-2 mb-2">
            <span  className="lg:px-2 px-0 font-bold text-gray-500  lg:text-xl"> نتيجة التكليفات :</span>
          ...
          <div className="flex justify-start flex-wrap items-center w-full gap-2 mb-2">
            <span  className="lg:px-2 px-0 font-bold text-gray-500  lg:text-xl"> نتيجة  الإختبارات :</span>
          ...
          <div className="flex justify-start flex-wrap items-center w-full gap-2 mb-2">
            <span  className="lg:px-2 px-0 font-bold text-gray-500  lg:text-xl"> إجمالي النتيجة النهائية :</span>
          ...
          {/* <div className="flex justify-start flex-wrap items-center w-full gap-2 mb-2">
            <span  className="lg:px-2 px-0 font-bold text-gray-500  lg:text-xl"> عدد المواد :</span>
            <span className="text-sm text-wrap md:text-xl lg:text-2xl line-clamp-1 font-bold">{(user?.UserOnSubject)?.length > 0}</span>
          </div>
          <div className="flex justify-start flex-wrap items-center w-full gap-2 mb-2">
            <span  className="lg:px-2 px-0 font-bold text-gray-500  lg:text-xl">  المواد :</span>
