...
export default function CreatePost() {
    ...
    return (
        <>
            ...
            {!toggle && UserLogedData?.role as React.ReactNode && UserLogedData?.role === 'OWNER' && <button onClick={() => setToggle(!toggle)} className="hover:text-blue-600 my-1 bg-background_color text-text_color w-full px-3 rounded cursor-pointer">إنشاء منشور</button>}
