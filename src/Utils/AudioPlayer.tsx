...
export default function AudioPlayer({ Book, audioUrl, BookTitle, setAudioUrl, play, setplay, ID, SetID, type, SahapyName, SetSahapyName }:
    ...
    return (
        <>
            {/*Player Audio Box */}
            <div className="fixed bottom-0 left-2 w-full flex flex-col justify-center items-center rounded h-fit px-2 py-1 bg-background_color shadow">
                {/* Progress Bar */}
                ...
                <div className="w-full flex justify-evenly items-center gap-2">
                    ...
                    <div className={`${styleProgress.volumeParent}`} >
                        <div className={`${styleProgress.volumeProgress} `}>
                            <input type="range" min="0" max="100" value={volume} onChange={(e) => handleVolume(e)} className='w-20 h-4 bg-second_background_color' />
